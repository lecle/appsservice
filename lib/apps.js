...
function onRequest(req, res) {
    ...
    var controller = require('./controllers/appsController');
    ...
    exports.container.getService('AUTH').then(function(service) {
        ...
        var reqData = {checklist : ['SESSION']};

        var deep = function(a, b) {
            return _.isObject(a) && _.isObject(b) ? _.assign(a, b, deep) : b;
        };

        service.send('check', _.assign(reqData, req.data, deep), function(err, res) {
            ...
            req.data.session = res.data.session;
