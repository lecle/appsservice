...
exports.read = function(req, res, container) {
    ...
    container.getService('MONGODB').then(function(service) {
        ...
        service.send('findOne', {collectionName : 'apps', query : {where : {objectId : req.params._objectId}}, data : data}, function(err, doc) {
...
exports.find = function(req, res, container) {
    ...
    if (req.session && req.session.userid)
        req._query.where._userid = req.session.userid;

    container.getService('MONGODB').then(function (service) {

        service.send('find', {collectionName : 'apps', query: {where: {objectId: req.params._objectId}}, data: data}, function (err, docs) {
...
exports.destroy = function(req, res, container) {
    ...
    container.getService('MONGODB').then(function(service) {
        ...
        service.send('destroy', {collectionName : 'apps', query : {where : {objectId : req.params._objectId}}}, function(err, doc) {
...
exports.destroyAll = function(req, res, container) {
    ...
    container.getService('MONGODB').then(function(service) {
        ...
        service.send('destroy', {collectionName : 'apps', query : {}}, function(err, doc) {
